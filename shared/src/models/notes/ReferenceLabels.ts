...
export const ReferenceLabels: ReferenceLabel[] = [
  ...
  },
  {
    ...
    noteCategory: NoteCategory.ORT2,
    referenceLabelName: 'OR TRN 2',
    visible: true,
    referenceLabelShortName: 'OR',
  },
  {
    ...
    noteCategory: NoteCategory.ORT1,
    referenceLabelName: 'OR TRN 1',
    visible: true,
    referenceLabelShortName: 'OR',
  },
  {
  ...
  },
  {
    ...
    noteCategory: NoteCategory.IEQUO1,
    referenceLabelName: 'IE Quotation 1',
    visible: true,
    referenceLabelShortName: 'IE',
  },
  {
  ...
  },
  {
    ...
    referenceLabelName: 'Quotation 1',
    visible: true,
    referenceLabelShortName: 'QUO',
  ...
  },
  {
    ...
    noteCategory: NoteCategory.QUO2,
    referenceLabelName: 'Quotation 2',
    visible: true,
    referenceLabelShortName: 'QUO',
